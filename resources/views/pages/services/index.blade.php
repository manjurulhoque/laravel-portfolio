            ...
            <table class="table table-bordered table-hover" id="kt_datatable">
                ...
                @foreach($services as $service)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('services.edit', $service->id) }}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                <span class="svg-icon svg-icon-md">
                                    <svg
                            ...
                            <a href="{{ route('services.destroy', $service->id) }}" class="btn btn-sm btn-clean btn-icon" title="Delete">
                                <span class="svg-icon svg-icon-md">
